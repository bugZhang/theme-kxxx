...
if ( ! function_exists( 'kxxx_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function kxxx_posted_on() {
	...
	$posted_on = sprintf(
		...
		esc_html_x( 'Posted on %s', 'post date', 'kxxx' ),
		'<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
	);

	$byline = sprintf(
		/* translators: %s: post author. */
		esc_html_x( 'by %s', 'post author', 'kxxx' ),
...
if ( ! function_exists( 'kxxx_entry_footer' ) ) :
/**
